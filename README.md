...
* This application uses envrion, make sure you enter PASSWORD=aJ941S@>A/<+ in your envrion file and then in settings.py file, enter 'PASSWORD': env("PASSWORD"), under the DATABASES section. You can change this to whatever you would like it to be.
